...
PiOS 还是早期开源项目，不是成熟产品。[ARCHITECTURE.md §9](../../ARCHITECTURE.md#9-known-gaps-current--target) 列了 Known Gaps，这里原样搬过来，每条加一句"装之前你要知道"。
...
> PiOS 是给"已经重度用 Claude / Codex、想让 AI 在你电脑上 7×24 跑、不怕改 yaml 看 log、能接受产品还是早期版本"的人的工具。如果这几条里有一条不符合，先别装。
