...
// 2026-04-28 决定 presence 不再走 ioreg（开发者离屏 5min 就 fail，pre-commit
// hook 变 flaky）。fixed to 'present' 让 T3 / chitchat 门控逻辑可测；个别需要
// 测 'away' 路径的子 case 在 try/finally 里临时改这个 env。
