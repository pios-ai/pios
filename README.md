...
>
> 当前版本：v0.7.13 · macOS arm64 · 求生期（不是成熟产品）
...
PiOS 在求生期。以下是**当前 v0.7.13 已知差距**（详见 [ARCHITECTURE.md §9](ARCHITECTURE.md#9-known-gaps-current--target)）：
...
*v0.7.13 · 2026-04-29 更新 · macOS arm64 · 求生期开源工程，不保证向后兼容。版本演进见 CHANGELOG.md。*
