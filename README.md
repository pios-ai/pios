...
**当前 v0.8.1 已知差距**（详见 [ARCHITECTURE.md §9](ARCHITECTURE.md#9-known-gaps-current--target)）：
...
*v0.8.1 · 2026-04-29 更新 · macOS arm64 · 不保证向后兼容。版本演进见 CHANGELOG.md。*
